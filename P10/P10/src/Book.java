...
public class Book {
   ...
   * @return true if and only if the object is a Book which shares all attributes
   *         with this one, false otherwise.
   */
  @Override
  public boolean equals(Object obj) {
    Book other = obj instanceof Book ? (Book) obj : null;
    return other != null &&
        other.authorFirstname.equals(authorFirstname) &&
        other.authorLastname.equals(authorLastname) &&
